...
def sum_until_prime_input():
    ...
    while True:
        ...
        if is_prime(user_input):
            break
        sum_of_inputs = sum_of_inputs + user_input
    print('The sum of the input integers is: ', sum_of_inputs)
...
def run_test_next_prime():
    ...
    # Test 6:
    print()
    print('TEST 6 STARTED!  Has it ended?')
    expected = 53
    ...
    # Test 7:
    print()
    print('TEST 7 STARTED!  Has it ended?')
    expected = 71
    actual = next_prime(68)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
    ...
    # Test 8:
    print()
    print('TEST 8 STARTED!  Has it ended?')
    expected = 17
    ...
    # Test 9:
    print()
    print('TEST 9 STARTED!  Has it ended?')
    expected = 97
    ...
    # Test 10:
    print()
    print('TEST 10 STARTED!  Has it ended?')
    expected = 127
    ...
    # Test 11:
    print()
    print('TEST 11 STARTED!  Has it ended?')
    expected = 101
...
def prime_gap(m):
    ...
    # ------------------------------------------------------------------
    a_prime = 2
    b_prime = next_prime(a_prime + 1)
    while b_prime - a_prime < m:
        a_prime = b_prime
        b_prime = next_prime(a_prime + 1)
...
def wait_for_sum_of_cubes(x):
    ...
    n = 1
    sum_of_cube = 0
    while sum_of_cube + n ** 3 < x:
        sum_of_cube = sum_of_cube + n ** 3
        n = n + 1
